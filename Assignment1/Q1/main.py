...
def main():
    ...
    knn_metrics = get_metrics(tree_predictions, metric_labels)
    ...
    nb_metrics = get_metrics(tree_predictions, metric_labels)
    ...
    svm_metrics = get_metrics(tree_predictions, metric_labels)
    ...
    get_metrics(svm_predictions, metric_labels)
    mlp_metrics = get_metrics(tree_predictions, metric_labels)
